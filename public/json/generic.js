  ...
  "nodes": [
    ...
    },
    {
      ...
      "nodes": [
        ...
        {"id": "fn", "script": "return {fn, graph, args: {...(args ?? {}), edge: undefined, args: undefined}}"},
        {"id": "fn_run", "ref": "run"},
    ...
    },
    {
      ...
      "nodes": [
        ...
        {"id": "edge", "ref": "arg", "value": "edge"},
        {"id": "edge_as", "ref": "get", "value": "as"},
        {"id": "is_edge_for_node", "ref": "script", "value": "console.log(edge); return edge && _graph.id.startsWith(edge.node_id)"},
        {"id": "default_edge", "ref": "if"},
        {"id": "return_str", "value": "return"},
        {"id": "args", "ref": "arg", "value": "args"},
        {"id": "is_parentest", "ref": "script", "value": "const parent = _lib.no.runtime.get_parent(_graph); return !_lib.no.runtime.get_parent(parent) || _graph.node_id !== parent.out"},
        ...
        {"id": "fn_el_from", "ref": "arg", "value": "element.from"},
        {"id": "fn_el_as", "ref": "arg", "value": "element.as"},
        {"id": "fn", "script": "return {fn, graph: _lib.no.runtime.get_parent(_graph), args: Object.fromEntries(Object.entries(args))}"},
        {"id": "fn_run", "ref": "run"},
        {"id": "result_entry", "ref": "array"},
        {"id": "fn_runnable", "ref": "runnable"},
        {"id": "edges_array", "ref": "array"},
        {"id": "edges", "script": "const edges = arr.map(e => e._value).filter(e => e && (e.as === edge || (edge === 'return' && (e.as === 'publish' || e.as === 'subscribe')))); console.log(edges); return edges;"},
        {"id": "entries", "ref": "map"},
        ...
        {"id": "out", "script": "console.log(res); console.log(edge); if(edge === 'return'){ _lib.no.runtime.update_result(_graph, res.result); _lib.no.runtime.remove_listener('*', 'subscribe-' + _graph.id); Object.entries(res.subscribe ?? {}).filter(kv => kv[1]).forEach(([k, v]) => { _lib.no.runtime.add_listener(k, 'subscribe-' + _graph.id, {...v, args: Object.assign({}, args, v.args, {result: edge === 'return' ? res[edge] : _lib.no.runtime.get_result(_graph.id)})}, false, _lib.no.runtime.get_parentest(_graph).id, true) }); } return res[edge]"}
      ],
      "edges": [
        {"from": "return_edge_arg", "to": "return_edge", "as": "value"},
        {"from": "return_edge_input", "to": "return_edge", "as": "otherwise"},
    ...
    },
    {
      ...
      "nodes": [
        ...
        {"id": "fn_el_from", "ref": "arg", "value": "element.from"},
        {"id": "fn_el_as", "ref": "arg", "value": "element.as"},
        {"id": "fn", "script": "return {fn, graph: _lib.no.runtime.get_parent(_graph), args: {...(args ?? {}), edge: undefined}}"},
        {"id": "fn_run", "ref": "run"},
        {"id": "result_entry", "ref": "array"},
        {"id": "fn_runnable", "ref": "runnable"},
