...
var ispromise = (a) => a && typeof a.then === "function" && !isWrappedPromise(a);
var isWrappedPromise = (a) => a && a.__kind === WRAPPED_KIND;
var tryCatch = (fn, t, c) => {
  try {
    return fn(t);
  } catch (e) {
...
var wrapPromise = (t, c) => isWrappedPromise(t) ? t : {
  __kind: WRAPPED_KIND,
...
var automerge_wasm_bg_default = "./automerge_wasm_bg-XSP6PAF5.wasm";
...
var automerge_enablePatches = instance.exports.automerge_enablePatches;
...
var automerge_popPatches = instance.exports.automerge_popPatches;
...
var create2 = instance.exports.create;
var load2 = instance.exports.load;
var encodeChange2 = instance.exports.encodeChange;
var decodeChange2 = instance.exports.decodeChange;
var initSyncState2 = instance.exports.initSyncState;
var importSyncState2 = instance.exports.importSyncState;
var exportSyncState2 = instance.exports.exportSyncState;
var encodeSyncMessage2 = instance.exports.encodeSyncMessage;
var decodeSyncMessage2 = instance.exports.decodeSyncMessage;
var encodeSyncState2 = instance.exports.encodeSyncState;
var decodeSyncState2 = instance.exports.decodeSyncState;
...
var automergeRefStore = async ({ nodysseusidb, persist = false }) => {
  ...
  const refs = {
    get: (id) => generic_nodes2[id] ?? structuredCloneMap.get(id),
    set: (id, graph) => {
    },
...
var sharedWorkerRefStore = async () => {
  const inflightRequests = /* @__PURE__ */ new Map();
  const sharedWorker = new SharedWorker("../sharedWorker.js?1", { type: "module" });
  let connectres;
  ...
  sharedWorker.port.addEventListener("message", (e) => (console.log("received", e), e).data.kind === "connect" ? connectres() : inflightRequests.get(e.data.id)(e.data));
  console.log(sharedWorker);
  sharedWorker.port.start();
  setTimeout(() => (console.log("posting message"), sharedWorker.port.postMessage({ kind: "keys", id: performance.now().toFixed() })), 1e3);
  ...
  return {
    get: (graphid) => {
      if (generic_nodes2[graphid])
        return generic_nodes2[graphid];
      return messagePromise({ kind: "get", graphid }).then((e) => e.graph);
    },
    set: (k, g) => {
      throw new Error("not implemented");
    },
...
var openNodysseusDB = () => openDB("nodysseus", 4, {
...
var webClientStore = async (refStore) => {
...
self.onconnect = (e) => {
  ...
  port.addEventListener("message", (e2) => {
    console.log("shared worker message", e2);
    if (store) {
...
console.log(await new Promise((res) => setTimeout(() => res("promises work"), 100)));
webClientStore((nodysseusidb) => automergeRefStore({ nodysseusidb, persist: true })).then((resStore) => {
