...
"@nodysseus.nodeDisplay": {"category":"nodysseus","edges":{"3euqttl":{"as":"value","from":"3euqttl","to":"out"},"819x0bh":{"as":"args","from":"819x0bh","to":"3euqttl"},"r8nekwc":{"as":"value","from":"r8nekwc","to":"3euqttl"},"7wglw1p":{"as":"fn","from":"7wglw1p","to":"r8nekwc"},"wz3fe9p":{"as":"run","from":"wz3fe9p","to":"r8nekwc"},"0zot8g9":{"as":"nodeId","from":"0zot8g9","to":"a4vqn33"},"678d6ki":{"as":"graph","from":"678d6ki","to":"a4vqn33"},"y0xjosj":{"as":"nodeId","from":"y0xjosj","to":"678d6ki"},"5yneigv":{"as":"output","from":"5yneigv","to":"2ai4sjh"},"6tf7lvy":{"as":"graphid","from":"6tf7lvy","to":"2ai4sjh"},"xqttsnb":{"as":"out","from":"xqttsnb","to":"2ai4sjh"},"7tetc9c":{"as":"graphid","from":"7tetc9c","to":"bkjzo9f"},"0v2jux9":{"as":"graphid","from":"0v2jux9","to":"vnek089"},"fwsjsnu":{"as":"_nodeId","from":"fwsjsnu","to":"819x0bh"},"vucpl3b":{"as":"_parent","from":"vucpl3b","to":"819x0bh"},"w58ugo7":{"as":"target","from":"w58ugo7","to":"vucpl3b"},"yolz5rm":{"as":"graphid","from":"yolz5rm","to":"w58ugo7"},"bim9zhi":{"as":"otherwise","from":"bim9zhi","to":"fwsjsnu"},"g7tfor8":{"as":"value","from":"g7tfor8","to":"fwsjsnu"},"bkjzo9f":{"as":"env","from":"bkjzo9f","to":"2ai4sjh"},"vnek089":{"as":"graph","from":"vnek089","to":"2ai4sjh"},"a4vqn33":{"as":"value","from":"a4vqn33","to":"7wglw1p"},"2ai4sjh":{"as":"otherwise","from":"2ai4sjh","to":"7wglw1p"}},"id":"@nodysseus.nodeDisplay","nodes":{"out":{"id":"out","name":"@nodysseus.nodeDisplay","ref":"return"},"3euqttl":{"id":"3euqttl","ref":"return"},"r8nekwc":{"id":"r8nekwc","ref":"@flow.ap"},"wz3fe9p":{"id":"wz3fe9p","value":"true"},"7wglw1p":{"id":"7wglw1p","ref":"@flow.default"},"a4vqn33":{"id":"a4vqn33","ref":"@js.script","value":"const fromargs = _lib.no.runtime.get_args(`${nodeId}/${graph?.out ?? \"out\"}-display-runnable`);\nreturn fromargs.fn ? fromargs : undefined;"},"678d6ki":{"id":"678d6ki","value":"return _lib.no.runtime.getGraphIdRef(nodeId);","ref":"@js.script"},"y0xjosj":{"id":"y0xjosj","ref":"arg","value":"_parent"},"0zot8g9":{"id":"0zot8g9","ref":"arg","value":"_nodeId"},"2ai4sjh":{"id":"2ai4sjh","ref":"@flow.graphRunnable"},"xqttsnb":{"id":"xqttsnb","ref":"arg","value":"_nodeId"},"bkjzo9f":{"id":"bkjzo9f","ref":"@js.script","value":"//console.log(\"in env\", _lib.no.runtime.get_args(\"@nodysseus.nodeDisplay/68g6wbw/y407zfo-display-runnable\"))\n//return _lib.no.runtime.get_args(\"@nodysseus.nodeDisplay/68g6wbw/y407zfo-display-runnable\")\n\nreturn {__kind: \"env\", data: {__graphid: graphid}}"},"7tetc9c":{"id":"7tetc9c","ref":"arg","value":"__graphid"},"vnek089":{"id":"vnek089","ref":"@js.script","value":"return _lib.no.runtime.get_parent(graphid) ?  _lib.no.runtime.getGraphIdRef(graphid) : graphid;"},"0v2jux9":{"id":"0v2jux9","ref":"arg","value":"_parent"},"6tf7lvy":{"id":"6tf7lvy","value":"@nodysseus.nodeDisplay"},"5yneigv":{"id":"5yneigv","value":"display"},"819x0bh":{"id":"819x0bh"},"vucpl3b":{"id":"vucpl3b","ref":"@data.get","value":"parent"},"w58ugo7":{"id":"w58ugo7","ref":"@js.script","value":"return _lib.no.runtime.get_parent(graphid);"},"yolz5rm":{"id":"yolz5rm","ref":"arg","value":"__graphid"},"fwsjsnu":{"id":"fwsjsnu","ref":"@flow.default"},"g7tfor8":{"id":"g7tfor8","ref":"arg","value":"__graph_value"},"bim9zhi":{"id":"bim9zhi","ref":"arg","value":"nodeId"}},"out":"out"}
},
  "edges": {
  }
}
