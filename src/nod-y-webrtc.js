...
import * as cryptoutils from '../node_modules/y-webrtc/src/crypto'
...
export class SignalingConn extends ws.WebsocketClient {
  ...
  send(data) {
    super.send({type: "sendToGroup", group: "group1", ackId: i++, dataType: "json", data})
  }
}
