    ...
    "@html.html_element": {
      ...
      "nodes": {
        ...
        "out": {
          "id": "out",
          "ref": "@js.script",
          "value": "if(!(typeof dom_type === 'string' && typeof children === 'object')){ console.log(dom_type, children, props, memo, value); throw new Error('invalid element');} return {dom_type, props, children: children, memo, value, ref: typeof props?.onref === 'function' && ((ref) => props.onref({ref}))}"
        },
        "value": {
          "id": "value",
          "ref": "arg",
