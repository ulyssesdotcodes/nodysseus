    	...
    	},
    	{
    		...
    		nodes: [
    			...
    			},
    			{
    				...
    				script: "return (expand || contract) && selected ? {display_graph: expand ?? contract, selected} : {display_graph, selected: node_id}"
    			},
    			{
    				id: "get_name",
    				args: [
    				...
    				script: "return display_graph.nodes.find(n => n.id === node_id).name"
    			},
    			{
    				id: "log",
    				type: "log"
    			...
    			},
    			{
    				...
    				script: "return !node_id ? [] : node_id.endsWith('/out') ? [[node_id.substring(0, node_id.lastIndexOf('/'))]] : name?.endsWith('/out') ? [[node_id]] : []"
    			},
    			{
    				id: "expand",
    				args: [
    			...
    			},
    			{
    				...
    				script: "return node_id.endsWith('/out') || name?.endsWith('/out')"
    			},
    			{
    				id: "out",
    				type: "default"
    	...
    	},
    	{
    		...
    		nodes: [
    			...
    			},
    			{
    				...
    				script: "return (!!selected_edge && key !== 'e') || (key === 'e' && editing === false && search === false) ? [key] : []"
    			},
    			{
    				id: "selected_edge",
    				type: "switch"
    			...
    			},
    			{
    				...
    				nodes: [
    					...
    					},
    					{
    						...
    						script: "return {className: error ? 'error' : '', id: 'result'}"
    					},
    					{
    						id: "container",
    						type: "h"
