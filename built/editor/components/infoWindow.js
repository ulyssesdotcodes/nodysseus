...
import { isNodeGraph, isNodeRef } from "src/types.js";
import { create_randid } from "src/util.js";
import generic from "../../generic.js";
import { nolib } from "../../nodysseus.js";
import { ChangeEditingGraphId, Copy, CreateNode, CreateRef, DeleteNode, ExpandContract, Paste, run_h, SaveGraph, SelectNode, UpdateEdge, UpdateNode } from "../util.js";
...
export const infoInput = ({ label, property, value, onchange, oninput, onkeydown, options, inputs, disabled, icon }) => ha.h('div', {
    class: 'value-input',
}, [
    ...
    ha.h('autocomplete-list', {
        ...
        disabled,
        onselect: (state, payload) => [{ ...state, inputs: Object.assign(state.inputs, { [`edit-text-${property}`]: undefined }) }, dispatch => dispatch(onchange, { value: payload.detail })],
...
export const infoWindow = ({ node, hidden, edges_in, link_out, editingGraph, editingGraphId, randid, ref_graphs, html_id, copied_graph, inputs, graph_out, editing, error, refGraphs, metadata, initialLayout, nodeArgs, nodeEdgeLabels }) => {
    ...
    return ha.h('div', { id: "node-info-wrapper", class: { "initial-layout": initialLayout } }, [ha.h('div', { class: "spacer before" }, []), ha.h('div', {
            ...
            ha.h('div', { class: "buttons" }, [
                !isOut && ((isNodeRef(node) && node.ref === "return") || isNodeGraph(node)) && ha.h('div', {
                    ...
                    ha.h('span', { class: 'material-symbols-outlined' }, ha.text(isNodeGraph(node) ? "unfold_more" : "unfold_less")),
